...
export const ko = {
  ...
  cost: {
    label: "이번 작업 예상 비용",
    zero: "₩0",
    note: "AI 자동 보정을 쓸 때마다 예상 비용이 더해져요. 무료 보정(크롭·색감)은 비용이 없어요.",
    reset: "초기화",
  ...
  ai: {
    ...
    errors: {
      ...
      geo_blocked: "지금 계신 지역에서는 클로드 접속이 막힌 것 같아요. VPN·네트워크를 확인해 주세요.",
      ...
      refusal: "AI가 이 사진의 보정 제안을 거절했어요. 다른 사진으로 시도해주세요.",
